...
urlpatterns = [
    ...
    re_path(r'^(?P<car_id>\d+)/permlist/$', car_view_with_permission_list, name='car_view_with_permission_list'),
    re_path(r'^(?P<id>\d+)/drive_default/$', drive_car_default, name='drive_car_default'),
    re_path(r'^(?P<id>\d+)/wash_default/$', wash_car_default, name='wash_car_default'),
    re_path(r'^(?P<id>\d+)/crash_default/$', crash_car_default, name='crash_car_default'),
    re_path(r'^wash$', wash, name='wash_class'),
    re_path(r'^crash$', crash, name='crash_class'),
    re_path(r'^permlist$', car_view_with_permission_list_for_class, name='car_view_with_permission_list_for_class'),
]